...
@Slf4j
@ControllerAdvice // bu anatasyon sayesinde tüm controllerda ki hatalar merkezi burada yakalanır.
public class GlobalErrorResponse {
    ...
    public ResponseEntity<BurgerErrorResponse> handleException(BurgerException burgerException) {
        ...
        log.error("BurgerException occured ! Exception deatils: ",burgerException.getMessage());
    ...
    public ResponseEntity<BurgerErrorResponse> handleException(Exception exception){
        ...
        log.error("Exception occured ! Exception deatils: ", exception.getMessage());
